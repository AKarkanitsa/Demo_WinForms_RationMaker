...
namespace WinFormApp
{
    public partial class RationMaker : Form
    {
        ...
        private void FillTreeViewProducts()
        {
           ...
           // Add a root TreeNode for each Category
            ...
            foreach (Category c in service.GetCategories())
            {
                ...
                // Add a child treenode for each Category object.
           ...
           if (e.Node.Parent != null)
            {
                ...
                if (product != null)
                {
                    ...
                    this.label1.Text = "Proteins: " + product.Protein.ToString();
                    this.label2.Text = "Fats: " + product.Fats.ToString();
                    this.label3.Text = "Carbs: " + product.Carbs.ToString();
                    this.label4.Text = "Calories: " + product.Calories.ToString();
                    this.label13.Text = "Weigth (gramms): " + product.Weight.ToString();
                  }
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            myButton.Text = "This is new button. Click Me!";
            myButton.Location = new Point(300, 400);
            myButton.Size = new Size(50, 150); 
            this.Controls.Add(myButton);
            myButton.Click += new System.EventHandler(button4_Click);
